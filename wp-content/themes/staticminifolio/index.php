...
<?php 
    // This will include all important head-files from Wordpress inclusive functions.php
wp_head();
?>
</head>
...
<!-- JS FILES --> 
<?php
    // inserts all importent footer-files (js-files) from wordpress including functions.php
    wp_footer();
?>
</body>
</html>